...
public class OkHttpUtils {
    ...
    public static OkHttpUtils getInstance() {
        Timber.d("OkHttpUtils() getInstance");
        if (okHttpUtils == null) {
    ...
    public OkHttpClient getClient() {
        Timber.d("OkHttpClient() getClient");
        return okHttpClient;
    }
    ...
    public OkHttpClient.Builder getOkHttpTrustCertificate(int connectTimeout, int readTimeout) {
        Timber.d("getOkHttpTrustCertificate() connect timeout: %s, read timeout: %s", connectTimeout, readTimeout);
        try {
    ...
    public OkHttpClient.Builder getOkHttpUtilsCert(int connectTimeout, int readTimeout) {
        Timber.d("getOkHttpUtilsCert() connect timeout: %s, read timeout: %s", connectTimeout, readTimeout);
        try {
    ...
    public void addHeaders(Request.Builder builder, Map<String, String> headers) {
        Timber.d("addHeaders() builder: %s headers: %s", builder, headers);
